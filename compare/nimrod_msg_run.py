...
from comparison_function import get_max_min, select_daytime_files_from_hour, mask_nighttime_values, filter_rain_rate, filter_by_cloud_mask, filter_elevation
...
from figures.plot_comparison_function import plot_rain_rate_vs_msg_channels, plot_distributions_by_rain_classes, plot_ets_trend, plot_spatial_percentile, plot_spatial_metrics, plot_distributions_by_elevation_classes
...
#Loop over the elevation classes
elev_min, elev_max = get_max_min(ds_oro,'orography')
print(elev_min,elev_max)
print(elevation_class_thresholds) #[0.1,2.5,10]
...
#plot_spatial_percentile(ds_msg_daytime_mask,ds_rain,[1,99],vis_channels,ir_channels,[lonmin, lonmax, latmin, latmax],path_outputs)
...
for i, elev_class_name in enumerate(elevation_class_names):
    ...
    plot_ets_trend(path_outputs,vis_channels,elev_class_name)
